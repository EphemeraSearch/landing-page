...
<div class="flex flex-col items-center stack-small">
	...
	<p class="sm:text-center">Discover the old photography, artwork, and humor of your ancestors.</p>
    ...
    <ul class="parent">
      <li class="flex items-center justify-between {isHighlighted === 1 ? 'highlight' : ''}"
        ...
        <div class="wrapper">
          <Picture host="EphemeraSearch" imgName="landscape.jpg" alt="An old black and white landscape photo"/>
        </div>
      ...
      <li class="flex items-center justify-between {isHighlighted === 2 ? 'highlight' : ''}"
        ...
        <div class="wrapper">
          <Picture host="EphemeraSearch" imgName="thanksgiving.jpg" alt="Thanksgiving art on a postcard"/>
        </div>
      ...
      <li class="flex items-center justify-between {isHighlighted === 3 ? 'highlight' : ''}"
        ...
        <div class="wrapper">
          <Picture host="ephemerasearch" imgName="motorcycle.jpg" alt="Black and white photo of an old motorcycle"/>
        </div>
